...
awful.key({ altkey, "Control" }, "-", function () lain.util.useless_gaps_resize(-1) end, {description = "decrement useless gaps", group = "tag"}),
  ...
  awful.key({altkey, 'Control'}, 'k', awful.tag.viewprev, {description = 'view previous', group = 'tag'}),
  awful.key({altkey, 'Control'}, 'j', awful.tag.viewnext, {description = 'view next', group = 'tag'}),
